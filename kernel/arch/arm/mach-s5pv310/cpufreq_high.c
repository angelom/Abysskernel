...
static unsigned int abyss_freq_table[] = {
	1704,1664,1600,1500,1400,1300,1200,1100,1000,900,800,700,600,500,400,200,100,50
};
...
static unsigned int freq_trans_table[CPUFREQ_LEVEL_END][CPUFREQ_LEVEL_END] = {
	...
	*/
	...
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 0, 4, 4, 4, 4, 4, 4, 4, 4 },
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0, 5, 5, 5, 5, 5, 5, 5 },
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0, 5, 5, 5, 5, 5, 5 },
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0, 5, 5, 5, 5, 5 },
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0,12,12,12,12 },
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0,12,12,12 },
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,10, 0,12,12 },
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,10,10, 0,12 },
	{ 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2,10,10,10, 0 }
};
...
/* ASV table to work 1.7GHz in DVFS has 18 asv level. */
static unsigned int s5pv310_asv_cpu_volt_table[18][CPUFREQ_LEVEL_END] = {
	{ 1650000, 1550000, 1500000, 1400000, 1200000, 1100000, 1150000, 1150000, 1100000, 1050000, 1000000, 950000, 950000, 925000, 925000, 925000, 925000, 925000 },
	{ 1600000, 1500000, 1450000, 1350000, 1299000, 1100000, 1100000, 1100000, 1050000, 1000000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1550000, 1450000, 1400000, 1300000, 1200000, 1100000, 1050000, 1050000, 1000000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1500000, 1400000, 1350000, 1250000, 1150000, 1050000, 1000000, 1000000, 950000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1450000, 1350000, 1300000, 1200000, 1100000, 1000000,  975000,  975000, 950000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1425000, 1325000, 1275000, 1175000, 1075000,  975000,  950000,  950000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1400000, 1300000, 1250000, 1150000, 1050000,  975000,  950000,  950000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1400000, 1300000, 1250000, 1150000, 1050000,  975000,  925000,  925000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1350000, 1250000, 1200000, 1100000, 1000000,  975000,  925000,  925000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1325000, 1225000, 1175000, 1075000,  975000,  950000,  925000,  925000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1325000, 1225000, 1175000, 1075000,  975000,  950000,  925000,  925000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1325000, 1225000, 1175000, 1075000,  975000,  950000,  925000,  925000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1325000, 1225000, 1175000, 1075000,  975000,  950000,  925000,  925000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
	{ 1325000, 1225000, 1175000, 1075000,  975000,  950000,  925000,  925000, 925000, 950000, 950000, 925000, 925000, 925000, 925000, 925000, 925000, 925000 },
...
static unsigned int asv_int_volt_table[18][LV_END] = {
	...
	{ 1050000, 950000, 950000 },	/* 10 */
	{ 1050000, 950000, 950000 },	/* 11 */
	{ 1050000, 950000, 950000 },	/* 12 */
	{ 1050000, 950000, 950000 },	/* 13 */
	{ 1050000, 950000, 950000 },	/* 14 */
	{ 1050000, 950000, 950000 },	/* 15 */
	{ 1050000, 950000, 950000 },	/* 16 */
	{ 1050000, 950000, 950000 },	/* 17 */
};
#ifdef CONFIG_CPU_S5PV310_EVT1
...
static int s5pv310_asv_table_update(void)
{
	...
	if (true) //(s5pv310_max_armclk == ARMCLOCK_1400MHZ)
...
ssize_t set_freq_table(unsigned char step, unsigned int freq)
{
	...
	switch(step)
	{
		...
		case 1: //1664
			...
			break;
		case 2: //1600
			if(freq >= 1664 || freq <= 1500) return -EINVAL;
			pll = (int)(freq / 8);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(3<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 8 * 1000;	
			break;
		case 3: //1500
			if(freq > 1600 || freq <= 1400) return -EINVAL;
			pll = (int)(freq / 8);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(3<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 8 * 1000;		
			break;
		case 4: //1400
			if(freq >= 1500 || freq <= 1300) return -EINVAL;
			pll = (int)(freq / 8);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(3<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 8 * 1000;	
			break;
		case 5: //1300
			if(freq >= 1400 || freq <= 1200) return -EINVAL;
			pll = (int)(freq / 8);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(3<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 8 * 1000;	
			break;
		case 6: //1200
			if(freq >= 1300 || freq <= 1100) return -EINVAL;
			pll = (int)(freq / 8);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(3<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 8 * 1000;	
			break;
		case 7: //1100
			if(freq >= 1200 || freq <= 1000) return -EINVAL;
			pll = (int)(freq / 4);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 4 * 1000;	
			break;
		case 8: //1000
			if(freq >= 1100 || freq <= 900) return -EINVAL;
			pll = (int)(freq / 4);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 4 * 1000;	
			break;
		case 9: //900
			if(freq >= 1000 || freq <  800) return -EINVAL;
			pll = (int)(freq / 4);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 4 * 1000;	
			break;
		case 10: //800
			if(freq >= 900 || freq <  700) return -EINVAL;
			pll = (int)(freq / 4);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x1));
			s5pv310_freq_table[step].frequency = pll * 4 * 1000;	
			break;
		case 11: //700
			if(freq >= 800 || freq <  600) return -EINVAL;
			pll = (int)(freq / 2);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x2));
			s5pv310_freq_table[step].frequency = pll * 2 * 1000;	
			break;
		case 12: //600
			if(freq >= 700 || freq <  500) return -EINVAL;
			pll = (int)(freq / 2);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x2));
			s5pv310_freq_table[step].frequency = pll * 2 * 1000;	
			break;
		case 13: //500
			if(freq >=  600 || freq <=  400) return -EINVAL;
			pll = (int)(freq / 2);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x2));
			s5pv310_freq_table[step].frequency = pll * 2 * 1000;	
			break;
		case 14: //400
			if(freq >=  500 || freq <=  200) return -EINVAL;
			pll = (int)(freq / 2);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x2));
			s5pv310_freq_table[step].frequency = pll * 2 * 1000;	
			break;
		case 15: //200
			if(freq >=  400 || freq <=  100) return -EINVAL;
			pll = (int)(freq / 1);
		...
		case 17: //50
			...
			pll = (int)(freq * 4);
			s5pv310_apll_pms_table[step] =	((pll<<16)|(6<<8)|(0x5));
			s5pv310_freq_table[step].frequency = pll * 250;	
			break;
		default:
			return -EINVAL;
	}
...
ssize_t show_freq_table(struct cpufreq_policy *policy, char *buf) {
      return sprintf(buf, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", 
		...
		s5pv310_freq_table[10].frequency/1000,s5pv310_freq_table[11].frequency/1000,
		s5pv310_freq_table[12].frequency/1000,s5pv310_freq_table[13].frequency/1000,
		s5pv310_freq_table[14].frequency/1000,s5pv310_freq_table[15].frequency/1000,
		s5pv310_freq_table[16].frequency/1000,s5pv310_freq_table[17].frequency/1000);
}
...
//		s5pv310_freq_table[L4].frequency, DISABLE_FURTHER_CPUFREQ);
	...
	policy->cpuinfo.min_freq = s5pv310_freq_table[17].frequency;
//	ret = cpufreq_driver_target(policy,
...
%dmhz: %d mV\n%dmhz: %d mV\n%dmhz: %d mV\n%dmhz: %d mV\n%dmhz: %d mV\n%dmhz: %d mV\n", 
		...
		s5pv310_freq_table[10].frequency/1000,exp_UV_mV[10]/1000,
		s5pv310_freq_table[11].frequency/1000,exp_UV_mV[11]/1000,
		s5pv310_freq_table[12].frequency/1000,exp_UV_mV[12]/1000,
		s5pv310_freq_table[13].frequency/1000,exp_UV_mV[13]/1000,
		s5pv310_freq_table[14].frequency/1000,exp_UV_mV[14]/1000,
		s5pv310_freq_table[15].frequency/1000,exp_UV_mV[15]/1000,
		s5pv310_freq_table[16].frequency/1000,exp_UV_mV[16]/1000,
		s5pv310_freq_table[17].frequency/1000,exp_UV_mV[17]/1000);
}
...
ssize_t store_UV_mV_table(struct cpufreq_policy *policy,
      ...
      int i = 0;
	  int u[18];
      ret = sscanf(buf, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", &u[0], &u[1], &u[2], &u[3], &u[4], &u[5], &u[6], &u[7], &u[8], &u[9], &u[10], &u[11], &u[12], &u[13], &u[14], &u[15], &u[16], &u[17]);
	  if(ret != 18) {
	      ret = sscanf(buf, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", &u[0], &u[1], &u[2], &u[3], &u[4], &u[5], &u[6],&u[7], &u[8], &u[9], &u[10], &u[11], &u[12], &u[13], &u[14], &u[15],&u[16]);
		  if(ret != 17) {
		      ret = sscanf(buf, "%d %d %d %d %d %d %d %d %d %d %d %d %d %d %d %d", &u[1], &u[2], &u[3], &u[4], &u[5], &u[6], &u[7], &u[8], &u[9], &u[10], &u[11], &u[12], &u[13], &u[14], &u[15], &u[16]);
			  if( ret != 16) return -EINVAL;
		  }
	  }
		for( i = 0; i < CPUFREQ_LEVEL_END; i++ )
		{
		...
		if(ret >= 16) exp_UV_mV[0] = u[0] * 1000;
		...
		exp_UV_mV[10] = u[10] * 1000;
		exp_UV_mV[11] = u[11] * 1000;
		exp_UV_mV[12] = u[12] * 1000;
		exp_UV_mV[13] = u[13] * 1000;
		exp_UV_mV[14] = u[14] * 1000;
		exp_UV_mV[15] = u[15] * 1000;
		exp_UV_mV[16] = u[16] * 1000;
		exp_UV_mV[17] = u[17] * 1000;
		return count;
}
...
Valid frequency step values are: 0 (400MHz), 1 (266MHz), 2 (133MHz)", 
		...
		s5pv310_freq_table[10].frequency/1000,busfreq_static_level[10],
		s5pv310_freq_table[11].frequency/1000,busfreq_static_level[11],
		s5pv310_freq_table[12].frequency/1000,busfreq_static_level[12],
		s5pv310_freq_table[13].frequency/1000,busfreq_static_level[13],
		s5pv310_freq_table[14].frequency/1000,busfreq_static_level[14],
		s5pv310_freq_table[15].frequency/1000,busfreq_static_level[15],
		s5pv310_freq_table[16].frequency/1000,busfreq_static_level[16],
		s5pv310_freq_table[17].frequency/1000,busfreq_static_level[17],
...
ssize_t store_smooth_target(struct cpufreq_policy *policy,
	...
	ret = sscanf(buf, "%d", &level);
	if(ret!=1) return -EINVAL;
	if(level<0 || level>16) return -EINVAL;
	smooth_target = level;
	return count;
}
